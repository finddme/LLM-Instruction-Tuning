...
# ---------------------------------------------trainer-Copy2-----------------------------------
# export NCCL_P2P_LEVEL=NVL && python -m torch.distributed.launch \
#     --nproc_per_node 2 \
#     training/trainer-Copy4.py \
#     --input-model EleutherAI/polyglot-ko-12.8b \
#     --deepspeed ./config/a100_config.json \
#     --epochs 2 \
#     --local-output-dir ./output/1 \
#     --per-device-train-batch-size 6 \
...
# ----------------------------------------------trainer-Copy5 accelerate----------------------------------
# --multi_gpu
# NCCL_DEBUG=INFO NCCL_P2P_LEVEL=NVL && accelerate launch  --multi_gpu\
#                 --machine_rank=1 --main_process_ip="10.41.0.5" --main_process_port=23456\
#                 --num_processes=2 --num_machines=2\
...
# torchrun --nproc_per_node 2 --master_port=23456\
#         --nnodes 2 --node_rank 1 --master_addr 10.41.0.5\
#         training/trainer-Copy2.py \
#         --input-model EleutherAI/pythia-2.8b  \
#         --deepspeed ./config/a100_config.json \
#         --epochs 2  --local-output-dir ./output/1 \
