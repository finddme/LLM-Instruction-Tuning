...
def load_tokenizer(pretrained_model_name_or_path: str = DEFAULT_INPUT_MODEL) -> PreTrainedTokenizer:
    ...
    tokenizer = AutoTokenizer.from_pretrained("EleutherAI/pythia-2.8b", return_token_type_ids=False)
...
# notebook_launcher(train, num_processes=6, mixed_precision="bf16")
